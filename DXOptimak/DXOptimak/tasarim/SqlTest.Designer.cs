namespace DXOptimak.tasarim
{
    partial class SqlTest
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGridView1.Location = new System.Drawing.Point(67, 186);
            ...
            this.textBox1.Size = new System.Drawing.Size(498, 127);
            this.textBox1.TabIndex = 1;
            this.textBox1.Text = "SELECT  hostname,\r\n        net_library,\r\n        net_address,\r\n        client_net" +
    "_address\r\nFROM    sys.sysprocesses AS S\r\nINNER JOIN    sys.dm_exec_connections A" +
    "S decc ON S.spid = decc.session_id";
            // 
            // button1
            // 
